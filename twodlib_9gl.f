...
d      PRINT 505,NSTEP,MONTH,IDAYX,NYEAR,DECL
505   FORMAT(' COMPLETE TIME STEP ',I5,' MONTH,DAY,YEAR = ',I2,'/',
     1I2,'/',I2,' DEC. ANGLE = ',F8.1)
      umax=umax*0.01
      umin=umin*0.01
d      PRINT 506,UMAX,UMIN,TMAXx,TMINx,VMAX,VMIN,WMAX,WMIN,gwmax,gwmin,
d     1pwmin,pwmax
...
d      WRITE(6,*)'IT3, IT2, IT1  ',IT3,IT2,IT1
...
C
        OPEN (78, FILE = '/misc/kah01/chj12/9d9e_trans/tgl_jan7980.xdr',
