...
C
       ...
       ccf='/misc/kah03/chj25/merra/delf/kyy_merra_'//ccyr(iiyr)//'.xdr'
...
C      
        ...
        chh = 
     > '/misc/kah03/chj25/merra/hnet/qnet_merra_sc_'//ccyr(iiyr)//'.xdr'
...
C
       ...
       ccfegw = '/misc/kah03/chj25/merra/eqgw/fegw_'//ccyr(iiyr)//'.xdr'
